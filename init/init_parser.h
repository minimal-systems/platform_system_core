 ...
 * 
 * This function checks the boot mode and performs the appropriate initialization.
 * If in recovery mode, it executes `recovery_init`. Otherwise, it parses
 * all directories specified in `init_dirs`.
 * 
