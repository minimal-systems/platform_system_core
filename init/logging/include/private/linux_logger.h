/*
 * Copyright (C) 2015 The Linux Open Source Project
 *
...
/* This file is used to define the internal protocol for the Linux Logger */

#pragma once

/* Linux private interfaces */
...
ssize_t __linux_log_pmsg_file_read(log_id_t logId, char prio,
                                   const char* prefix,
                                   __linux_log_pmsg_file_read_fn fn,
                                   void* arg);
